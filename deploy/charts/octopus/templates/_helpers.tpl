...
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "sftpgo.select-labels" . }}
{{- end -}}

{{- define "sftpgo.select-labels" -}}
app.kubernetes.io/name: {{ include "sftpgo.name" . }}
app.kubernetes.io/instance: {{ include "sftpgo.fullname" . }}
app.kubernetes.io/part-of: {{ include "sftpgo.name" . }}
{{- end -}}

{{- define "sftpgo.webServiceName" -}}
{{- printf "%s-web" (include "sftpgo.fullname" .)  -}}
{{- end -}}

{{- define "sftpgo.sftpServiceName" -}}
{{- printf "%s-sftp" (include "sftpgo.fullname" .)  -}}
{{- end -}}