...
func NewHTTPServer(c *conf.Server, service *service.Service) *http.Server {
	...
	srv.HandlePrefix("/v1/platformmanage/platformstorageconfig", api.NewPlatformServiceHandler(service.PlatformService, options...))
	srv.HandlePrefix("/v1/platformmanage/platformconfigkey", api.NewPlatformServiceHandler(service.PlatformService, options...))
	return srv
}
