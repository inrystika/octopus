...
func (r MetadataApiApiGetUsersMetadataChecksRequest) Execute() ([]MetadataCheck, *http.Response, error) {
	return r.ApiService.GetUsersMetadataChecksExecute(r)
}
...
func (a *MetadataApiService) GetUsersMetadataChecksExecute(r MetadataApiApiGetUsersMetadataChecksRequest) ([]MetadataCheck, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  []MetadataCheck
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataApiService.GetUsersMetadataChecks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/metadata/users/checks"
...
func (r MetadataApiApiStartUserMetadataCheckRequest) Execute() (*ApiResponse, *http.Response, error) {
	return r.ApiService.StartUserMetadataCheckExecute(r)
}
...
func (a *MetadataApiService) StartUserMetadataCheckExecute(r MetadataApiApiStartUserMetadataCheckRequest) (*ApiResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataApiService.StartUserMetadataCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/metadata/users/{username}/check"
