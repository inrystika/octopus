...
func (r DefenderApiApiDeleteDefenderHostByIdRequest) Execute() (*ApiResponse, *http.Response, error) {
	return r.ApiService.DeleteDefenderHostByIdExecute(r)
}
...
func (a *DefenderApiService) DeleteDefenderHostByIdExecute(r DefenderApiApiDeleteDefenderHostByIdRequest) (*ApiResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.DeleteDefenderHostById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/defender/hosts/{id}"
...
func (r DefenderApiApiGetBanTimeRequest) Execute() (*BanStatus, *http.Response, error) {
	return r.ApiService.GetBanTimeExecute(r)
}
...
func (a *DefenderApiService) GetBanTimeExecute(r DefenderApiApiGetBanTimeRequest) (*BanStatus, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BanStatus
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.GetBanTime")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/defender/bantime"
...
func (r DefenderApiApiGetDefenderHostByIdRequest) Execute() (*DefenderEntry, *http.Response, error) {
	return r.ApiService.GetDefenderHostByIdExecute(r)
}
...
func (a *DefenderApiService) GetDefenderHostByIdExecute(r DefenderApiApiGetDefenderHostByIdRequest) (*DefenderEntry, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DefenderEntry
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.GetDefenderHostById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r DefenderApiApiGetDefenderHostsRequest) Execute() ([]DefenderEntry, *http.Response, error) {
	return r.ApiService.GetDefenderHostsExecute(r)
}
...
func (a *DefenderApiService) GetDefenderHostsExecute(r DefenderApiApiGetDefenderHostsRequest) ([]DefenderEntry, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.GetDefenderHosts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/defender/hosts"
...
func (a *DefenderApiService) GetScoreExecute(r DefenderApiApiGetScoreRequest) (*ScoreStatus, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ScoreStatus
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.GetScore")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/defender/score"
...
func (r DefenderApiApiUnbanHostRequest) Execute() (*ApiResponse, *http.Response, error) {
	return r.ApiService.UnbanHostExecute(r)
}
...
func (a *DefenderApiService) UnbanHostExecute(r DefenderApiApiUnbanHostRequest) (*ApiResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefenderApiService.UnbanHost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/defender/unban"
