...
func (m * MockApplet) ExecTemplateTranslator(packet *framework.AppletPacket) (*typeJob.Job, error) {
	# ...implement code...
	return nil, nil
}
...
func (m * MockApplet) ExecTemplateDecorator(packet *framework.AppletPacket) (*typeJob.Job, error) {
	# ...implement code...
	return nil, nil
}

func (m * MockApplet) ExecSchedulerBinder(packet *framework.AppletPacket) (*typeJob.Job, error) {
	# ...implement code...
	return nil, nil
}
