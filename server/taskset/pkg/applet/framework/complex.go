...
func (c * complexFeatureAppletDelegator) ExecTemplateTranslator(packet *AppletPacket) (*typeJob.Job, error) {
...
func (c * complexFeatureAppletDelegator) ExecTemplateDecorator(packet *AppletPacket) (*typeJob.Job, error) {
	if applet, err := c.dispatch(packet); err == nil {
...
func (c * complexFeatureAppletDelegator) ExecSchedulerBinder(packet *AppletPacket) (*typeJob.Job, error) {
	if applet, err := c.dispatch(packet); err == nil {
