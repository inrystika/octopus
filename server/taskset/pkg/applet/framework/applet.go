...
func (fa * featureAppletDelegator) ExecTemplateTranslator(packet *AppletPacket) (*typeJob.Job, error) {
...
func (fa * featureAppletDelegator) ExecTemplateDecorator(packet *AppletPacket) (*typeJob.Job, error) {
	return fa.applet.ExecTemplateDecorator(fa.wrapperPacket(packet))
}

func (fa * featureAppletDelegator) ExecSchedulerBinder(packet *AppletPacket) (*typeJob.Job, error) {
