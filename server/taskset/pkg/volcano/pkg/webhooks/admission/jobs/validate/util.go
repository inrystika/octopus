...
var policyEventMap = map[busv1alpha1.Event]bool{
	...
	busv1alpha1.RoleCompletedEvent: true,
	busv1alpha1.RoleFailedEvent: 	true,
	busv1alpha1.RoleSucceededEvent: true,
...
var policyActionMap = map[busv1alpha1.Action]bool{
	...
	busv1alpha1.TaskSetFailedAction:	true,
	busv1alpha1.TaskSetSucceededAction: true,
	busv1alpha1.TaskSetCompletedAction: true,
	busv1alpha1.NoActionAction:    		true,
