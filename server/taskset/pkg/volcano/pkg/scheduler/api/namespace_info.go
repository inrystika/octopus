...
const (
	...
	// DefaultNamespacePriority is the default priority of namespace
	DefaultNamespacePriority = -936521
)
...
// GetWeight returns weight of a namespace, any invalid case would get default value
func (n *NamespaceInfo) GetPriority() int32 {
	if n == nil {
		return DefaultNamespacePriority
	}
	return n.Priority
}
...
func NewNamespaceCollection(name string) *NamespaceCollection {
	n := &NamespaceCollection{
		Name:        name,
		priority: 	 DefaultNamespacePriority,
...
func (n *NamespaceCollection) UpdatePriority(priority int32) {
	n.priority = priority
}
