...
type JobLister interface {
	...
	List(selector labels.Selector) (ret []*typeJob.Job, err error)
...
// List lists all Jobs in the indexer.
func (s *jobLister) List(selector labels.Selector) (ret []*typeJob.Job, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*typeJob.Job))
	})
	return ret, err
}
...
type JobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*typeJob.Job, error)
...
// List lists all Jobs in the indexer for a given namespace.
func (s jobNamespaceLister) List(selector labels.Selector) (ret []*typeJob.Job, err error) {
...
// Get retrieves the Job from the indexer for a given namespace and name.
func (s jobNamespaceLister) Get(name string) (*typeJob.Job, error) {
