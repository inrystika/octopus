...
func CreateOrUpdateConfigMap(job *typeJob.Job, kubeClients kubernetes.Interface, data map[string]string, cmName string) error {
...
func CreateOrUpdateSecret(job *typeJob.Job, kubeClients kubernetes.Interface, data map[string][]byte, secretName string) error {
...
func DeleteConfigmap(job *typeJob.Job, kubeClients kubernetes.Interface, cmName string) error {
...
func DeleteSecret(job *typeJob.Job, kubeClients kubernetes.Interface, secretName string) error {
