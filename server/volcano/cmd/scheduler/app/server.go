...
import (
	...
	typeScheduler "server/volcano/pkg/scheduler"
	...
	predicates "server/volcano/pkg/scheduler/plugins/predicatesResourcepool"
)
...
func Run(opt *options.ServerOption) error {
	...
	// register predicatesResourcepool pluginbuilder
	typeFw.RegisterPluginBuilder(predicates.PluginName, predicates.New)

	sched, err := typeScheduler.NewScheduler(config,
		opt.SchedulerName,
		opt.SchedulerConf,
		opt.SchedulePeriod,
		opt.DefaultQueue,
