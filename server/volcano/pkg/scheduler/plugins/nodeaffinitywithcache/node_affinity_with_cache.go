...
func (p *NodeAffinityWithCache) Name() string {
	return PluginName
}

func (p *NodeAffinityWithCache) OnSessionOpen(ssn *framework.Session) {
	panic("implement me")
}

func (p *NodeAffinityWithCache) OnSessionClose(ssn *framework.Session) {
	panic("implement me")
}

func New(aruguments framework.Arguments) framework.Plugin {
	return &NodeAffinityWithCache{pluginArguments: aruguments}
}
