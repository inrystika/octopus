    ...
    <div>
        ...
        >
            ...
            <div slot="footer" class="dialog-footer">
                <el-button v-if="showTraning" type="success" @click="traningAndSave('traning')">开始训练</el-button>
                <el-button v-if="showTemplate" type="primary" @click="traningAndSave('save')">保存模板</el-button>
