<template>
    <div>
        <div class="searchForm">
            <searchForm :searchForm=searchForm @searchData="getSearchData" :blurName="'任务名称 搜索'"></searchForm>
        </div>
        <el-button type="primary" @click="open()" class="create">批量删除</el-button>
        <el-button type="primary" @click="create" class="create">创建任务</el-button>
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" @click="open(scope.row)"
                        v-if="scope.row.status==='failed'||scope.row.status==='succeeded'||scope.row.status==='stopped'">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <!-- 创建对话框 -->
        <createDialog v-if="createDialog" @cancel="cancel" @confirm="confirm" @close="close" :row="row" :flag="flag">
        </createDialog>
        <!-- 详情对话框 -->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            open(val) {
                let message = ''
                if (val) { message = '此操作将永久删除该训练任务' }
                else { message = '此操作将永久批量删除该训练任务' }
