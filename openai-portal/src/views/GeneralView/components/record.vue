<template>
  <div>
    <el-dialog :title="recordType === 1 ? '机时消费记录' : '机时充值记录'" width="70%" :visible.sync="createFormVisible"
      ...
      <el-table :data="recordList" :header-cell-style="{'text-align':'left','color':'black'}"
      ...
      <div class="pagination">
        <el-pagination :current-page="pageIndex" :page-sizes="[10, 20, 50]" :page-size="pageSize"
